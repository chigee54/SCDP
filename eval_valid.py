...
import join
from Custom_model import Custom_Model, PromptBERT
import glob
        ...
        for idx, document_path in enumerate(tqdm(glob.glob(filename + '/*.txt'))):
            ...
            for id, para in enumerate(para_list):
                ...
                for i in range(id):
                    ...
                    data_plus.append((feature_plus, int(label)))
...
if __name__ == '__main__':
    ...
    bert_path = 'D:/zzj_project/pretrained_model/bert_based_uncased_english'
    ...
    output_dir = 'output/dataset1/result'
    valid_path = 'pan22/dataset1/validation'
    ...
    truth = read_ground_truth_files(valid_path)
